package com.michal.tictactoeonline.common

object AppConstants {
    const val SESSIONS_PATH = "sessions"
    const val PLAYERS_PATH = "players"
    const val ERROR_EMPTY_USERNAME = "Username field is empty."
    ...
    const val ERROR_USERNAME_EXISTS = "Player with this username already exists."
}